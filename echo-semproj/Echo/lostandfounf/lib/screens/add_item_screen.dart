...
class AddItemScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Report Item', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w800, fontSize: 18)),
        actions: [
          Obx(() {
        ...
        child: Obx(() => Column(
          ...
          children: [
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            'I Lost Something',
                            style: TextStyle(
                              color: controller.isLost.value ? Colors.white : Colors.black87,
            ...
            if (!controller.isLost.value) ...[
               ...
               const Center(
                 child: Text('Register a\nRecovery.', textAlign: TextAlign.center, style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800, fontSize: 32, height: 1.1)),
               ),
               const SizedBox(height: 12),
               Center(
                 child: Text('Help the community by providing accurate\ndetails about the item you\'ve located on\ncampus.', textAlign: TextAlign.center, style: TextStyle(color: Colors.grey[600], fontSize: 14)),
               )
            ],
                  ...
                  children: [
                    Container(
                      ...
                      child: controller.imagePath.value != null 
                        ? ClipRRect(
                            borderRadius: BorderRadius.circular(20),
                            // FIX APPLIED HERE: kIsWeb condition added
                            child: kIsWeb 
                      ...
                      Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            const Text('Tap to upload item photo', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black87, fontSize: 15)),
                            const SizedBox(height: 4),
                            Text('JPEG, PNG up to 10MB', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                          ],
                        ),
                      )
                  ],
            ...
            DropdownButtonFormField<String>(
              ...
              items: controller.categories.map((c) => DropdownMenuItem(value: c, child: Text(c, style: const TextStyle(fontSize: 15, color: Colors.black87)))).toList(),
              onChanged: (v) {
  ...
  Widget _buildLabel(String text) {
    return Text(text, style: const TextStyle(color: AppColors.primary, fontWeight: FontWeight.w800, fontSize: 11, letterSpacing: 1.5));
  }
}